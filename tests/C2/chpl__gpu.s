...
)
{
	...
	cvta.local.u64 	%SP, %SPL;
	ld.param.u64 	%rd8, [chpl_gpu_kernel_DefaultRectangular_line_1536__param_7];
	ld.param.u64 	%rd7, [chpl_gpu_kernel_DefaultRectangular_line_1536__param_6];
	ld.param.u64 	%rd6, [chpl_gpu_kernel_DefaultRectangular_line_1536__param_5];
	ld.param.u64 	%rd5, [chpl_gpu_kernel_DefaultRectangular_line_1536__param_4];
...
{
	.local .align 8 .b8 	__local_depot24[248];
	.reg .b64 	%SP;
	.reg .b64 	%SPL;
	.reg .pred 	%p<2>;
	.reg .b32 	%r<7>;
	...
	cvta.local.u64 	%SP, %SPL;
	ld.param.u64 	%rd7, [chpl_gpu_kernel_DefaultRectangular_line_1536_6_param_6];
	ld.param.u64 	%rd6, [chpl_gpu_kernel_DefaultRectangular_line_1536_6_param_5];
	ld.param.u64 	%rd5, [chpl_gpu_kernel_DefaultRectangular_line_1536_6_param_4];
...
{
	.local .align 8 .b8 	__local_depot30[368];
	.reg .b64 	%SP;
	.reg .b64 	%SPL;
	.reg .pred 	%p<4>;
	.reg .b32 	%r<12>;
...
{
	.local .align 8 .b8 	__local_depot31[240];
	.reg .b64 	%SP;
	.reg .b64 	%SPL;
	.reg .pred 	%p<2>;
	.reg .b32 	%r<7>;
	...
	cvta.local.u64 	%SP, %SPL;
	ld.param.u64 	%rd7, [chpl_gpu_kernel_test_line_43_2_param_6];
