...
.global .align 1 .b8 __unnamed_57[51] = {95, 105, 99, 95, 116, 104, 101, 115, 101, 95, 104, 101, 108, 112, 95, 68, 101, 102, 97, 117, 108, 116, 82, 101, 99, 116, 97, 110, 103, 117, 108, 97, 114, 68, 111, 109, 95, 49, 95, 105, 110, 116, 54, 52, 95, 116, 95, 111, 110, 101, 0};
.visible .global .align 8 .u64 _cstr_literal_4911 = generic(__unnamed_57);
.global .align 1 .b8 __unnamed_58[18] = {99, 104, 112, 108, 95, 77, 111, 100, 117, 108, 101, 68, 101, 105, 110, 105, 116, 0};
.visible .global .align 8 .u64 _cstr_literal_4912 = generic(__unnamed_58);
.global .align 1 .b8 __unnamed_59[36] = {95, 115, 101, 114, 105, 97, 108, 105, 122, 101, 87, 114, 97, 112, 112, 101, 114, 40, 98, 105, 110, 97, 114, 121, 83, 101, 114, 105, 97, 108, 105, 122, 101, 114, 41, 0};
.visible .global .align 8 .u64 _cstr_literal_4913 = generic(__unnamed_59);
.global .align 1 .b8 __unnamed_60[38] = {95, 115, 101, 114, 105, 97, 108, 105, 122, 101, 87, 114, 97, 112, 112, 101, 114, 40, 98, 105, 110, 97, 114, 121, 68, 101, 115, 101, 114, 105, 97, 108, 105, 122, 101, 114, 41, 0};
.visible .global .align 8 .u64 _cstr_literal_4914 = generic(__unnamed_60);
.global .align 1 .b8 __unnamed_61[32] = {91, 100, 111, 109, 97, 105, 110, 40, 49, 44, 105, 110, 116, 40, 54, 52, 41, 44, 111, 110, 101, 41, 93, 32, 105, 110, 116, 40, 54, 52, 41, 0};
.visible .global .align 8 .u64 _cstr_literal_4915 = generic(__unnamed_61);
.global .align 1 .b8 __unnamed_62[35] = {95, 105, 99, 95, 99, 104, 112, 108, 95, 100, 105, 114, 101, 99, 116, 95, 115, 116, 114, 105, 100, 101, 100, 95, 114, 97, 110, 103, 101, 95, 105, 116, 101, 114, 0};
.visible .global .align 8 .u64 _cstr_literal_4916 = generic(__unnamed_62);
.global .align 1 .b8 __unnamed_63[33] = {91, 100, 111, 109, 97, 105, 110, 40, 49, 44, 105, 110, 116, 40, 54, 52, 41, 44, 111, 110, 101, 41, 93, 32, 117, 105, 110, 116, 40, 54, 52, 41, 0};
.visible .global .align 8 .u64 _cstr_literal_4917 = generic(__unnamed_63);
.global .align 1 .b8 __unnamed_64[63] = {95, 105, 99, 95, 116, 104, 101, 115, 101, 95, 68, 101, 102, 97, 117, 108, 116, 82, 101, 99, 116, 97, 110, 103, 117, 108, 97, 114, 65, 114, 114, 95, 49, 95, 105, 110, 116, 54, 52, 95, 116, 95, 111, 110, 101, 95, 117, 105, 110, 116, 54, 52, 95, 116, 95, 105, 110, 116, 54, 52, 95, 116, 0};
.visible .global .align 8 .u64 _cstr_literal_4918 = generic(__unnamed_64);
.global .align 1 .b8 __unnamed_65[75] = {95, 105, 99, 95, 116, 104, 101, 115, 101, 95, 95, 114, 101, 102, 95, 95, 97, 114, 114, 97, 121, 95, 68, 101, 102, 97, 117, 108, 116, 82, 101, 99, 116, 97, 110, 103, 117, 108, 97, 114, 65, 114, 114, 95, 49, 95, 105, 110, 116, 54, 52, 95, 116, 95, 111, 110, 101, 95, 117, 105, 110, 116, 54, 52, 95, 116, 95, 105, 110, 116, 54, 52, 95, 116, 0};
...
.visible .global .align 8 .u64 _cstr_literal_4109 = generic(__unnamed_74);
...
.visible .entry chpl_gpu_kernel_ChapelBase_line_1515_2(
	...
	.param .u64 chpl_gpu_kernel_ChapelBase_line_1515_2_param_3,
	.param .u64 chpl_gpu_kernel_ChapelBase_line_1515_2_param_4,
	.param .u32 chpl_gpu_kernel_ChapelBase_line_1515_2_param_5
)
{
	.local .align 8 .b8 	__local_depot4[112];
	.reg .b64 	%SP;
	.reg .b64 	%SPL;
	.reg .pred 	%p<2>;
	.reg .b32 	%r<17>;
	...
	cvta.local.u64 	%SP, %SPL;
	ld.param.u32 	%r1, [chpl_gpu_kernel_ChapelBase_line_1515_2_param_5];
	ld.param.u64 	%rd5, [chpl_gpu_kernel_ChapelBase_line_1515_2_param_4];
	ld.param.u64 	%rd4, [chpl_gpu_kernel_ChapelBase_line_1515_2_param_3];
...
{
	.local .align 8 .b8 	__local_depot29[80];
	.reg .b64 	%SP;
	.reg .b64 	%SPL;
	.reg .pred 	%p<2>;
	.reg .b32 	%r<7>;
