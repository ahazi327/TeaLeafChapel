...
)
{
	...
	ld.param.u64 	%rd3, [chpl_gpu_kernel_DefaultRectangular_line_1536__param_0];
	ld.param.u64 	%rd6, [chpl_gpu_kernel_DefaultRectangular_line_1536__param_1];
	mov.u32 	%r1, %ctaid.x;
	mov.u32 	%r2, %ntid.x;
	mov.u32 	%r3, %tid.x;
	...
	cvta.to.global.u64 	%rd5, %rd4;
	ld.param.u64 	%rd7, [chpl_gpu_kernel_DefaultRectangular_line_1536__param_2];
...
)
{
	...
	ld.param.u64 	%rd4, [chpl_gpu_kernel_DefaultRectangular_line_1536_3_param_0];
	...
	setp.gt.s64 	%p1, %rd3, %rd6;
	@%p1 bra 	$L__BB20_2;
	ld.param.u64 	%rd5, [chpl_gpu_kernel_DefaultRectangular_line_1536_3_param_3];
	cvta.to.global.u64 	%rd1, %rd5;
...
)
{
	...
	ld.param.u64 	%rd3, [chpl_gpu_kernel_DefaultRectangular_line_1536_5_param_0];
...
)
{
	...
	ld.param.u64 	%rd3, [chpl_gpu_kernel_test_line_43__param_0];
	ld.param.u64 	%rd6, [chpl_gpu_kernel_test_line_43__param_1];
	mov.u32 	%r1, %ctaid.x;
	mov.u32 	%r2, %ntid.x;
	mov.u32 	%r3, %tid.x;
	mul.wide.s32 	%rd9, %r1, %r2;
	...
	cvta.to.global.u64 	%rd5, %rd4;
	ld.param.u64 	%rd7, [chpl_gpu_kernel_test_line_43__param_2];
	cvta.to.global.u64 	%rd8, %rd7;
	shl.b64 	%rd13, %rd12, 3;
	add.s64 	%rd1, %rd5, %rd13;
	add.s64 	%rd2, %rd8, %rd13;
