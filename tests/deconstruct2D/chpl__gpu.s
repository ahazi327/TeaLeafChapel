...
)
{
	...
	ld.param.u64 	%rd16, [chpl_gpu_kernel_test_line_44__param_0];
	ld.param.u64 	%rd18, [chpl_gpu_kernel_test_line_44__param_1];
	mov.u32 	%r1, %ctaid.x;
	mov.u32 	%r2, %ntid.x;
	mov.u32 	%r3, %tid.x;
	...
	@%p1 bra 	$L__BB25_4;
	ld.param.u64 	%rd20, [chpl_gpu_kernel_test_line_44__param_2];
	cvta.to.global.u64 	%rd3, %rd20;
	ld.global.u64 	%rd5, [%rd3+88];
	ld.global.u64 	%rd6, [%rd3+96];
	setp.gt.s64 	%p2, %rd5, %rd6;
	@%p2 bra 	$L__BB25_4;
	ld.param.u64 	%rd17, [chpl_gpu_kernel_test_line_44__param_4];
	cvta.to.global.u64 	%rd1, %rd17;
	ld.param.u64 	%rd19, [chpl_gpu_kernel_test_line_44__param_3];
