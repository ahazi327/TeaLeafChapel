module cheby_driver{
    ...
    proc cheby_init_driver(ref chunk_var : chunks.Chunk, ref setting_var : settings.setting, 
        ...
        calculate_2norm(setting_var.halo_depth, chunk_var.u, bb, chunk_var.reduced_OneD, 
    ...
    proc cheby_main_step_driver (ref chunk_var : chunks.Chunk, ref setting_var : settings.setting, 
        ...
        {
            error = 0.0;
            calculate_2norm(setting_var.halo_depth, chunk_var.r, error, chunk_var.reduced_OneD, 
                chunk_var.reduced_local_domain);
        }
